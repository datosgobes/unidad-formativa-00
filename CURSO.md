...
Materiales formativos datos.gob.es (2026)

__Descripción de la unidad__

Esta unidad presenta la guía de uso y el alcance general de los materiales formativos de datos.gob.es (Iniciativa Aporta). Describe el propósito de las unidades, sus destinatarios, los conocimientos previos recomendados y las pautas básicas sobre licencia, glosario y referencias.
</center>
...
**Unidad 1. Datos abiertos: conceptos básicos y beneficios**

1. Conceptos básicos
2. Beneficios

**Unidad 2. Datos abiertos e innovación: casos de uso sectoriales**

**Unidad 3. Marco normativo y estratégico de los datos abiertos**

1. Europeo
2. Español
3. Autonómico y local

**Unidad 3. Estrategia y plan de acción para la apertura de datos**

1. Por qué es necesaria una estrategia
2. Visión y objetivos estratégicos
3. Principios rectores
4. Barreras y cómo superarlas
5. Gobernanza y roles
6. Plan de acción operativo
7. Indicadores y métricas de seguimiento
8. Participación y comunidad
9. Sostenibilidad y futuro

**Unidad 4. Proceso técnico/práctico de apertura de datos**

1. Análisis del entorno tecnológico y organizativo
2. Inventario y priorización de conjuntos y servicios de datos
3. Evaluación de calidad inicial
4. Preparación, normalización y automatización de la carga de los datos
5. Publicación en un portal de datos abiertos
6. Promoción y reutilización
7. Mantenimiento y soporte

**Unidad 5. Características del catálogo de información pública (datos.gob.es) y proceso de federación**

**Unidad 6. Interoperabilidad entre catálogos: DCAT-AP y perfiles relacionados**

**Unidad 7. Cómo reutilizar datos abiertos: consejos y buenas prácticas**

**Unidad 7. Tratamiento y limpieza de datos**
...
Está permitida su reproducción, distribución, comunicación pública y transformación para generar una obra derivada, sin ninguna restricción, siempre que se cite al titular de los derechos:
...
- **Fuente:** origen de la definición o de la información que respalda el concepto o información que se está presentado.
- **Ejemplo:** casos concretos de algunos de los temas o conceptos que permitan una mejor comprensión de lo tratado.
- **Tip:** consejo, truco o dato práctico y útil que ayudará a comprender lo presentado.
- **Más información:** material de relevancia que complementa lo explicado.
- **Saber más:** información adicional de cada tema con referencias y documentos de consulta.
